...
?>
  ...
  <div class="w3-padding-16 w3-content w3-text-grey" id="contact">
      ...
      <div class="row">
        ...
        <div class="col-sm-8">
            <br><br>
            <h2 class="w3-text-light-grey">Police Registration</h2>
        </div>
    ...
    <hr>
      ...
      <div class="row">
          <div class="col-md-8">
            ...
            <p><input class="w3-input w3-padding-16" type="text" placeholder="Name of the Police Station" required name="name" id="name"></p>
          ...
          <div class="col-md-4" style="background-color:#ccc; font-size:20px; color:red;">
              ...
              <p style="color:black; font-size:15px; text-align:center">The Police ID is:</p>
        ...
        function addInfo(){
            ...
            xmlhttp.onreadystatechange=function() {
             ...
             var x6 = document.forms["registerForm"]["email"].value;
                if (x1== "") {
                    alert("Police name must be filled out");
                    return false;
                
                }
                
                else if(x3==""){
                    alert("Police address must be filled out");
                    return false;
                }
                else if(x4==""){
                    alert("Police city must be filled out");
                    return false;
                }
                else if(x5==""){
                    ...
                    xmlhttp.open("GET","insertPolice.php?policename="+name+"&address="+address+"&city="+city+"&tp="+tp+"&email="+email,true);
